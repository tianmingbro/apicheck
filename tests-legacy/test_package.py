#!/usr/bin/env python3
"""
Quick verification script for keypilot package
...
def test_package():
    ...
    try:
        from keypilot import APIPoolClient, __version__
    ...
    print("✓ Module has __main__.py (tested separately via: python -m keypilot)")
    ...
    print("4. Or use SDK in your code: from keypilot import APIPoolClient")
